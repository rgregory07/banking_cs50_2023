...
const BankData = () => {
    ...
    },
    {
      ...
      cellEditorParams: function (params) {
        ...
        switch (selectedCategory) {
          ...
          case "Pebbles & Pine":
            return { values: SubcategoryPebbles };
          case "Kidlet Kare":
            return { values: SubcategoryKidlet };
          case "Medical":
          ...
          case "Ryan Freelance":
            return { values: SubcategoryRyanFreelance };
        }
      },
      filter: "agSetColumnFilter",
    },
  ...
  //   const saveRemoveToDatabase = (data) => {
  //     console.log("clicked delete");
  //     data.forEach((id) => {
  //       console.log(id);
  //       let url = `http://localhost:8000/bankapp/bankdata/delete/${data.id}/`;
  //       axios.delete(
  //         url,
  //         { id },
  //         { headers: { "Content-Type": "application/json" } }
  ...
  //     saveRemoveToDatabase(selectedRowData);
  //   }, []);
